...
public class AIRecoveryController {
    ...
    private final AIRecoveryExecutionService
            aiRecoveryExecutionService;

    private final RecoverySagaOrchestrator
            recoverySagaOrchestrator;
    ...
    public AIRecoveryController(
        ...
        this.aiRecoveryService =
                aiRecoveryService;

        this.aiRecoveryExecutionService =
                aiRecoveryExecutionService;

        this.recoverySagaOrchestrator =
                recoverySagaOrchestrator;
    }
    ...
    public Map<String, Object> analyzePaymentRecovery(
        ...
        return aiRecoveryService
                .analyzePaymentRecovery(paymentId);
    }
